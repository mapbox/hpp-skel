...
# Script to generate compile_commands.json based on build2 output
# Works by accepting output from stdin, parsing it, and
...
# Usage:
#
# make | ./scripts/generate_compile_commands.py > compile_commands.json
...
TOKEN_DENOTING_COMPILED_FILE='-x c++'
